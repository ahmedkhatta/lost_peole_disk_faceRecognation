package Login_menu_screen;

import get_Data.RegisterFace;
import data_Screen.Data;
import recognizer_and_connected_screen.RecognizeFace;
import helper.ConectaBanco;
import helper.RoundImage;
import helper.ChartDaily;
...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_title_menu.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(111, 111, 111)
                .addComponent(txt_title_menu, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Play_Button_25px.png"))); // NOI18N
        jButton12.setText("Our news channel on YouTube");
        ...
        jButton6.setText("Group our news on Facebook");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/logo_1.jpg"))); // NOI18N
        jLabel3.setText(" ");

        jButton13.setBackground(new java.awt.Color(0, 0, 0));
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Cancel_25px.png"))); // NOI18N
        jButton13.setText(" ");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
            try {
                URI site = new URI("https://www.facebook.com/akhattab595");
                desktop.browse(site);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
            try {
                URI site = new URI("https://www.youtube.com/channel/UCFjmzpkzphmZe6-Kl2r1c8w?view_as=subscriber");
                desktop.browse(site);
            } catch (IOException | URISyntaxException e) {
                JOptionPane.showMessageDialog(null, "Error: " + e);
            }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
            try {
                URI site = new URI("https://www.linkedin.com/in/ahmed-khattab-a421b118b/");
                desktop.browse(site);
            } catch (IOException | URISyntaxException e) {
                JOptionPane.showMessageDialog(null, "Error: " + e);
            }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
            try {
                URI site = new URI("https://www.instagram.com/ahmed_123khattab_/");
                desktop.browse(site);
            } catch (IOException | URISyntaxException e) {
                JOptionPane.showMessageDialog(null, "Error: " + e);
            }
