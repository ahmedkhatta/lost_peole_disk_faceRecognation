...
import recognizer_and_connected_screen.SendWhatsapp;
...
public class Data extends javax.swing.JDialog {
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        try {
            ...
            txt_insta.setText(String.valueOf(conecta.rs.getString("day_lost")));
            txt_linkedin.setText(String.valueOf(conecta.rs.getString("email")));
            txt_github.setText(String.valueOf(conecta.rs.getString("location")));
    ...
    private void sendMessage_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendMessage_btnActionPerformed
        ...
        mod.setday_lost(txt_insta.getText());
        mod.setemail(txt_linkedin.getText());
        mod.setlocation(txt_github.getText());
        cod.update(mod, id);
