...
public class RegisterFace extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Facebook Url");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 70, -1));

        jLabel8.setForeground(new java.awt.Color(170, 170, 170));
        jLabel8.setText("Day lost");
                        ...
                        if (webSource.grab()) {
                            ...
                            try {
                                if (g.drawImage(buff, 0, 0, 360, 390, 0, 0, buff.getWidth(), buff.getHeight(), null)) {
                                    if (runnable == false) {
                                        System.out.println("Salve a image");
                                        this.wait();
                                    }
                                }
                            } catch (Exception e) {
    ...
    public void insertDatabase() {
        ...
        mod.setday_lost(txt_instagram.getText());
