...
public class SendWhatsapp extends javax.swing.JDialog {
    ...
    public SendWhatsapp(java.awt.Frame parent, boolean modal, String nome, String telefone) {
        ...
        text_lbl.setText("MR," + name + "You can send a message to the owner of the picture using WhatsApp!");
    }
    ...
    private void initComponents() {
        ...
        number_lbl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                number_lblActionPerformed(evt);
            }
        });
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        try {
            dispose();
            String url = "https://api.whatsapp.com/send?phone=01552344879" + tel.replace(" ", "").replace("(", "").replace(")", "").replace("-", "") + "&text=" + text_lbl.getText().replace(" ", "%20");
    ...
    private void number_lblActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_number_lblActionPerformed
  
    }//GEN-LAST:event_number_lblActionPerformed
